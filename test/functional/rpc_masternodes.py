...
class MasterNodeTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Send 20000 to %s %s" % (mnaddr0, self.nodes[0].sendtoaddress(mnaddr0, 20000)))
        ...
        #exit(0)
        configfile0=tmpdir+"/node0/ioncoin.conf"
        ...
        wconfigline03="masternodeaddr=127.0.0.1:34567\n"
        ...
        mnconfigline0="mn0 127.0.0.1:34567 " + mnpriv0 + " " + txhash0 + " " + str(outputidx0) + "\n"
