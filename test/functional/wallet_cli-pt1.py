...
class WalletCLITest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        privKeys = ['cSM1CBAT7WtiiTmcqR9oStX7ZzzHxZhcAS2ioViYjQ1chj5Ug5Aj']
        ...
        outputs = {'gDWd9CWACa74cPfM5tkbdEvmftNsHnNsbv': 0.1}
        ...
        # Importaddress
        ###
        self.log.info("Import address gHitZVZmRZBmF7i9ocyoqK5bczhmw5HcGU to Node 0 %s" % self.nodes[0].importaddress("gHitZVZmRZBmF7i9ocyoqK5bczhmw5HcGU", "New Test"))
        self.log.info("Address in wallet %s" % self.nodes[0].getaddressesbyaccount("New Test"))
        ###
        # Import Private Key
        ###
        self.log.info("Import Private Key cPbkeNdaFZaLiDH2ntfQ7KwDRMkq8GFh3BnwQxsbAraLBN2friy7")
        self.nodes[0].importprivkey("cPbkeNdaFZaLiDH2ntfQ7KwDRMkq8GFh3BnwQxsbAraLBN2friy7", "PrivKeyTest")
        self.log.info("Address in wallet should be gQFGMsDQrUdtseEmhSfPkmtc4VGTYLBYzm %s" % self.nodes[0].getaddressesbyaccount("PrivKeyTest"))
        ###
        # lock/unlock unspent
        ###
        self.log.info("Balance Node 1 %s" % self.nodes[1].getbalance())
