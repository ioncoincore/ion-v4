...
class SendFromTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Sending 500 ion to %s" % sendfrom)
        ...
        self.log.info("Sending 500 ion to %s" % smaddr1)
        self.log.info("Sending 500 ion to %s" % smaddr2)
        ...
        self.log.info("Sending 500 ion to %s" % addressix)
